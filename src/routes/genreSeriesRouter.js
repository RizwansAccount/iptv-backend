...
import { getGenreSeries, createGenreSeries, updateGenreSeries, deleteGenreSeries, getAllGenreSeries } from '../controllers/genreSeriesController.js';
...
router.get('/', authenticate, getAllGenreSeries);
